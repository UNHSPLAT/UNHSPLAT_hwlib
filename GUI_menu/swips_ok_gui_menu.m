classdef swips_ok_gui_menu < handle
    ...
    methods
        ...
        function connectPHCallback(obj)
            ...
            %% -- Acquisition tab --
            ypos = 0.92;
            uicontrol('Parent', acqTab, 'Style', 'text', 'Units', 'normalized', ...
                'Position', [0.05 ypos 0.9 lblH], 'String', 'Dwell time (ms)', ...
                'FontSize', 10, 'HorizontalAlignment', 'left');
            ypos = ypos - edH;
            eb_dwell = uicontrol('Parent', acqTab, 'Style', 'edit', 'Units', 'normalized', ...
            ...
            uicontrol('Parent', acqTab, 'Style', 'text', 'Units', 'normalized', ...
                ...
                'FontSize', 10, 'HorizontalAlignment', 'left');
            ypos = ypos - edH;
            eb_thr = uicontrol('Parent', acqTab, 'Style', 'edit', 'Units', 'normalized', ...
            ...
            uicontrol('Parent', acqTab, 'Style', 'text', 'Units', 'normalized', ...
                ...
                'FontSize', 10, 'HorizontalAlignment', 'left');
            ypos = ypos - edH;
            eb_nsamp = uicontrol('Parent', acqTab, 'Style', 'edit', 'Units', 'normalized', ...
            ...
            uicontrol('Parent', acqTab, 'Style', 'text', 'Units', 'normalized', ...
                ...
                'FontSize', 10, 'HorizontalAlignment', 'left');
            ypos = ypos - edH;
            eb_refresh = uicontrol('Parent', acqTab, 'Style', 'edit', 'Units', 'normalized', ...
                'Position', [0.05 ypos 0.9 edH], 'String', num2str(obj.parentInst.refreshRate), 'FontSize', 10);

            btnH = 0.065; btnGap = 0.015;
            ypos = ypos - dy;

            % Connect button with embedded progress bar
            hConnectBtn = uicontrol('Parent', acqTab, 'Style', 'pushbutton', 'Units', 'normalized', ...
            ...
            %% -- Histogram tab --
            ypos = 0.92;
            uicontrol('Parent', histTab, 'Style', 'text', 'Units', 'normalized', ...
                'Position', [0.05 ypos 0.9 lblH], 'String', 'Hist Min', ...
                'FontSize', 10, 'HorizontalAlignment', 'left');
            ypos = ypos - edH;
            eb_min = uicontrol('Parent', histTab, 'Style', 'edit', 'Units', 'normalized', ...
            ...
            uicontrol('Parent', histTab, 'Style', 'text', 'Units', 'normalized', ...
                ...
                'FontSize', 10, 'HorizontalAlignment', 'left');
            ypos = ypos - edH;
            eb_max = uicontrol('Parent', histTab, 'Style', 'edit', 'Units', 'normalized', ...
