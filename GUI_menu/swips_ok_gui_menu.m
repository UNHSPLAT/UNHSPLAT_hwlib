classdef swips_ok_gui_menu < handle
    ...
    methods
        ...
        function callPHD(obj)
            ...
            edit_boxes = zeros(1, 3);
            
            % Create label
            uicontrol('Style', 'text', ...
                'Position', [5 90 130 40], ...
                'String', 'Number of Samples',...
                'FontSize', 11);
            
            % Create edit box
            edit_boxes(1) = uicontrol('Style', 'edit', ...
                'Position', [35 65 70 25], ...
                'String', num2str(1000), ...
                'FontSize', 10);

            % Create label
            uicontrol('Style', 'text', ...
                'Position', [145 90 120 40], ...
                'String', 'Dwell time (ms)',...
                'FontSize', 11);
            
            % Create edit box
            edit_boxes(2) = uicontrol('Style', 'edit', ...
                'Position', [170 65 70 25], ...
                'String', num2str(1), ...
                'FontSize', 10);

            % Create label
            uicontrol('Style', 'text', ...
                'Position', [285 95 130 30], ...
                'String', 'PH Threshold',...
                'FontSize', 11);
            
            % Create edit box
            edit_boxes(3) = uicontrol('Style', 'edit', ...
                'Position', [305 65 70 25], ...
                'String', num2str(200), ...
                'FontSize', 10);
            ...
            function applyCallback(~, ~)
                try
                    ...
                    obj.parentInst.getPHD(Nsamples, dwell, PHThreshold);
